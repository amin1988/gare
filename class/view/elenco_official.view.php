...
include_model("UtSocieta","Official");
include_class("Sesso");

class ElencoOfficialView
{
	private $elenco;
	...
	{
		$ut = UtSocieta::crea();
		$this->elenco = Official::officialSocieta($ut->getIdSocieta());
	}
	...
	public function stampa()
	{
		...
		?>
			<div align="center">
				<div id="ele_official">
						<div class="Gare_soc_right"><h1><?php echo $lang["elenco_official"]; ?></h1></div>
		...
		{?><div class="Gare_soc_right"><h1><?php echo $lang["no_elenco_official"]; ?></h1></div><?php }
	}
}