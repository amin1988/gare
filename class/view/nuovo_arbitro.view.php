...
include_controller("soc/nuovo_arbitro");

class NuovoArbitroView
{
	private $ctrl;
	
	public function __construct()
	{
		$this->ctrl = new ArbitroEsternoCtrl();
	}
	...
	<div align="center">
		<div id="new_arbitro">
			<form method="post">
				...
				<div class="Gare_soc_right"><h1><?php echo $lang["nuovo_arbitro"]; ?></h1></div>
